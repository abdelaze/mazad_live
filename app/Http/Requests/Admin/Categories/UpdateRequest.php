...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name'                           => ['required','min:3','max:255',Rule::unique('categories','name->en')->ignore($this->category)->whereNull('deleted_at')],
            'name_ar'                        => ['required','min:3','max:255',Rule::unique('categories','name->ar')->ignore($this->category)->whereNull('deleted_at')],
