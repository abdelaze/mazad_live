...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name'                           => ['required','min:3','max:255',Rule::unique('sub_categories','name->en')->ignore($this->subcategory)->where('category_id' , $this->category_id)->whereNull('deleted_at')],
            'name_ar'                        => ['required','min:3','max:255',Rule::unique('sub_categories','name->ar')->ignore($this->subcategory)->where('category_id' , $this->category_id)->whereNull('deleted_at')],
