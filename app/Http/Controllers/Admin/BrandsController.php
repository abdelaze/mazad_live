...
class BrandsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.brands.create' , compact('cats'));
    }
    ...
    {
        $cats      = Category::where('status' , 1)->orderBy('position' , 'ASC')->get();
        $subcats   = SubCategory::where('status' , 1)->where('category_id' , $brand->category_id)->orderBy('position' , 'ASC')->get();
        return view('admin.brands.edit' , compact('brand' , 'cats' , 'subcats'));
    }
