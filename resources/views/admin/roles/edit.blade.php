...
@section('title') @lang('translation.edit_role') @endsection
@push('css')
    <!-- select2 css -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control" placeholder="Role Name" value="{{ $role->name }}" required>
                                        @error('name')
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check mb-3">
                                         <input class="form-check-input" type="checkbox" value="{{$value->id}}"  {{ in_array($value->id, $rolePermissions) ? "checked" : "" }}  name="permission[]" id="permission">
