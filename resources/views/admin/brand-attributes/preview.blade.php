...
<form id="store-inputs" action="{{route('brand-attributes.store')}}" method="POST">
@csrf
...
<label class="font-size-14">{{__('translation.select brand')}}:</label>
<select class="form-control mb-3" name="brand_id" required>
    <option disabled selected>{{__('translation.select brand')}}</option>
...
<form id="store-inputs" action="{{route('translation.brand-attributes.store')}}" method="POST">
@csrf
<input type="hidden" name="input_label" value="{{$requestData['input_label']}}" class="form-control">
<input type="hidden" name="input_label_ar" value="{{$requestData['input_label_ar']}}" class="form-control">
<input type="hidden" name="input_type" value="{{$requestData['input_type']}}" class="form-control">
...
@include('admin.brand-attributes.scripts.store-inputs')
