...
@section('title') {{  __('translation.category_attributes') }} @endsection
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="repeater" action="{{route('brand-attributes.inputs.preview')}}" method="POST" id="generate-new-input">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
...
@push('script')
@include('admin.brand-attributes.scripts.preview-input-html')
@include('admin.brand-attributes.scripts.detect-input-radio-selected')
@endpush
