...
@section('title') {{  trans('translation.edit_subcategory') }} @endsection
@push('css')
    <!-- select2 css -->
...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">{{  trans('translation.edit_subcategory') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{  trans('translation.Dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{  trans('translation.edit_subcategory') }}</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">{{  trans('translation.edit_subcategory') }}</h4>
                            ...
                            <div data-repeater-list="outer-group" class="outer">
                                <div data-repeater-item class="outer">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="name" name="name" type="text" class="form-control" placeholder="{{ trans('translation.name_en') }}" value="{{ $subcategory->getTranslation('name', 'en') }}" required>
                                            @error('name')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="name_ar" name="name_ar" type="text" class="form-control" placeholder="{{ trans('translation.name_ar') }}" value="{{ $subcategory->getTranslation('name', 'ar') }}" required>
                                            @error('name_ar')
                                                <span style="color: red"> {{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="form-check form-switch form-switch-lg mb-3 col-md-2" dir="ltr">
                                            <input class="form-check-input" type="checkbox" id="SwitchCheckSizelg" name="status" {{ ($subcategory->status == 1)  ? 'checked' : '' }}>
                                        </div>
                                    </div>
