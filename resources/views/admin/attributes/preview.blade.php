...
<form id="store-inputs" action="{{route('attributes.store')}}" method="POST">
@csrf
...
<label class="font-size-14">{{__('translation.select_category')}}:</label>
<select class="form-control mb-3" name="category_id" required>
    <option disabled selected>{{__('translation.select_category')}}</option>
...
<form id="store-inputs" action="{{route('translation.attributes.store')}}" method="POST">
@csrf
<input type="hidden" name="input_label" value="{{$requestData['input_label']}}" class="form-control">
<input type="hidden" name="input_label_ar" value="{{$requestData['input_label_ar']}}" class="form-control">
<input type="hidden" name="input_type" value="{{$requestData['input_type']}}" class="form-control">
...
@include('admin.attributes.scripts.store-inputs')
