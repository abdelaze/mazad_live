        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="repeater" action="{{route('attributes.inputs.preview')}}" method="POST" id="generate-new-input">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
...
@push('script')
@include('admin.attributes.scripts.preview-input-html')
@include('admin.attributes.scripts.detect-input-radio-selected')
@endpush
