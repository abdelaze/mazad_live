...
@section('title') @lang('translation.privacy_policies') @endsection
                ...
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <div class="search-box me-2 mb-2 d-inline-block">
                            <div class="position-relative">
                                <h4 class="card-title">{{ trans('translation.privacy_policies') }}</h4>
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <a href="javascript:void(0)" id="createNewData" class="btn btn-info btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i>   {{ trans('translation.add_policy') }} </a>
                        </div>
                    </div><!-- end col--> 
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="privacy_policy_datatable"  class="table align-middle table-nowrap table-check">
                                    ...
                                    @foreach ($datas  as $key=>$data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {!! Form::open(['method' => 'DELETE','route' => ['privacy_policies.destroy', $data->id],'style'=>'display:inline']) !!}
...
@push('script')
  ...
  <script>
      $(document).ready(function() {
           ...
           var table =  $("#privacy_policy_datatable").DataTable(
                { 
                    language: {
                    url : localeUrl
                },
            ...
            var id = $(this).data('id');
            $.get("{{ route('privacy_policies.index') }}" +'/' + id +'/edit', function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                url: "{{ route('privacy_policies.store') }}",
                type: "POST",
                dataType: 'json',
                _token     :  '{{ csrf_token() }}',
