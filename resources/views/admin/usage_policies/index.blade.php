...
@section('title') @lang('translation.usage_policies') @endsection
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <div class="search-box me-2 mb-2 d-inline-block">
                            <div class="position-relative">
                                <h4 class="card-title">{{ trans('translation.usage_policies') }}</h4>
                    ...
                    <div class="table-responsive">
                        <table id="usage_policy_datatable"  class="table align-middle table-nowrap table-check">
                                    ...
                                    @foreach ($datas  as $key=>$data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {!! Form::open(['method' => 'DELETE','route' => ['usage_policies.destroy', $data->id],'style'=>'display:inline']) !!}
...
@push('script')
  ...
  <script>
      $(document).ready(function() {
           ...
           var table =  $("#usage_policy_datatable").DataTable(
                { 
                    language: {
                    url : localeUrl
                },
            ...
            var id = $(this).data('id');
            $.get("{{ route('usage_policies.index') }}" +'/' + id +'/edit', function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                url: "{{ route('usage_policies.store') }}",
                type: "POST",
                dataType: 'json',
                _token     :  '{{ csrf_token() }}',
