...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mazdats', function (Blueprint $table) {
            $table->id();
           ...
           // $table->double('start_price', 15, 8)->default(0.00);
           $table->double('min_price', 15, 8)->default(0.00);
